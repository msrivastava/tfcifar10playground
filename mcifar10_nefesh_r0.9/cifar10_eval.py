...
tf.app.flags.DEFINE_integer('num_examples', 6060,
...
def eval_once(saver, summary_writer, top_k_op, summary_op, logits, labels, new_top_values_op):
  ...
  with tf.Session() as sess:
    ...
    try:
      ...
      new_predicts_for_each_label = [0 for i in range(101)]
      new_correct_predicts_for_each_label = [0 for i in range(101)]
      new_actual_amount_per_label = [0 for i in range(101)]
      step = 0
